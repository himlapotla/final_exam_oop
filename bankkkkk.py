...
while(True):
    ...
    if m_op == 1:
        ...
        addd = input('enter your address : ')
        ac_tyy = input('enter your account type : ')

        Customer(namee, emaill, addd, ac_tyy)
        print('bank account has been created successfully. ')
        print()
        print('now enter your account number to do anything as user : ')
        ac_number = int(input('what is your account number : '))
        print()
        for an in Bank.accuntnumbers:
            if an == ac_number:
                print('you have signed in as an user. what do you want to do ?')
